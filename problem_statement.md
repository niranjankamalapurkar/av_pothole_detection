...
**Core Objective:**
We need to design an end-to-end Pothole Detection and Mitigation system that allows the AV to intelligently map and navigate road surface irregularities. The system must fulfill a dual mandate:
